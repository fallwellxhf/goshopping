...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="http://192.168.227.130/${images[0]}" jqimg="http://192.168.227.130/${images[0]}" width="350">
                </div>
                <div id="spec-n5">
        ...
        <div class="shop_goods_show_right">
            <ul>
                <li>
                    <strong style="font-size:14px; font-weight:bold;">${goods.goodsname}</strong>
                </li>
                <li>
                    <label>价格：</label>
                    <span><strong>${goods.goodsprice?string("￥#,###.##")}</strong>元</span>
                </li>
                <li>
                    <label>运费：</label>
                    <span>卖家承担运费</span>
